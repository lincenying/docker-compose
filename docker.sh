...
docker pull swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/api-bun-postgre:1.26.0729
docker tag swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/api-bun-postgre:1.26.0729 lincenying/api-bun-postgre:1.26.0729
docker rmi swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/api-bun-postgre:1.26.0729

docker pull swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/api-express:1.26.0728
docker tag swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/api-express:1.26.0728 lincenying/api-express:1.26.0728
docker rmi swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/api-express:1.26.0728
...
docker pull swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/app-vue3-ssr:1.26.0727
docker tag swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/app-vue3-ssr:1.26.0727 lincenying/app-vue3-ssr:1.26.0727
docker rmi swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/app-vue3-ssr:1.26.0727
