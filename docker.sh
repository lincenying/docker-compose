...
docker pull swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/app-nuxt:1.26.0806
docker tag swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/app-nuxt:1.26.0806 lincenying/app-nuxt:1.26.0806
docker rmi swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/app-nuxt:1.26.0806

docker pull swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/app-php:1.26.0829
docker tag swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/app-php:1.26.0829 lincenying/app-php:1.26.0829
docker rmi swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/app-php:1.26.0829
...
docker pull swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/nginx-php:1.26.0829
docker tag swr.cn-north-4.myhuaweicloud.com/ddn-k8s/docker.io/lincenying/nginx-php:1.26.0829 lincenying/nginx-php:1.26.0829
